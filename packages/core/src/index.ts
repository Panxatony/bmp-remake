...
export { playMatchday, playReplays, matrixFor, matchStrength, writeResult, writePairings, afterMatch, kaderVorbereitung, moralWeg, bookEvents, type LiveBooking } from "./sim/matchday.ts";
