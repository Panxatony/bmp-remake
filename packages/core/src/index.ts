...
export { playMatchday, playReplays, matrixFor, writeResult, writePairings, afterMatch, bookEvents, type LiveBooking } from "./sim/matchday.ts";
...
export { playEuropaDay, playPlayoffDay, afterCupDay, playCupMatch, initialDraw, nextRoundDraw, decideTie, europeanParticipants, currentPairs, cupRoundOf, legPlayed, orderList, clearCupResults, cupNames, CUP_TABLE, CUP_ROUND, LEG_FLAG, HOLDER, DFB_WINNER, PLAYOFF_RESULT, ROUND_PAIRS, type CupMatch, type CupFinal } from "./sim/europa.ts";
...
export { contractOffers, contractScore, acceptOffer, declineOffer, rejectOffer, salaryDemand, contractCheck, contractRefusals, contractRefusalAnnouncements, MAX_CONTRACT_YEARS, tooLongText, type ContractOffer } from "./sim/contracts.ts";
